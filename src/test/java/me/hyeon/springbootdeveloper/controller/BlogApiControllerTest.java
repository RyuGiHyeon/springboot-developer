...
class BlogApiControllerTest {
    ...
    @Autowired  // 빈 주입 (빈 : 스프링 컨테이너에서 관리하는 객체)
    ...
    public void findArticle() throws Exception{
        ...
        Article savedArticles = blogRepository.save(Article.builder()
                .title(title)
                .content(content)
                .build());

        // when
        final ResultActions resultActions = mockMvc.perform(get(url, savedArticles.getId()));
